...
var canChange = function (start, target) {
  const startWithoutUnderscore = start.replace(/_/g, "");
  const targetWithoutUnderscore = target.replace(/_/g, "");

  if (startWithoutUnderscore !== targetWithoutUnderscore) {
    return false;
  }
  ...
  while (startIndex < n && targetIndex < n) {
    ...
    if (startIndex === n || targetIndex === n) break;
